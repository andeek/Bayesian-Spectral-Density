...
<<space1-ar4, echo=FALSE, message=FALSE, warning=FALSE, fig.show='hold', fig.width=7, fig.height=5, out.width='.49\\textwidth', fig.cap='Tests of pairwise independence for every other Fourier frequency starting at the first and second Fourier frequencies, respectively.', fig.pos='H'>>=
g_space1a.ar4
g_space1b.ar4
@

<<space2-ar4, echo=FALSE, message=FALSE, warning=FALSE, fig.show='hold', fig.width=5, fig.height=5, out.width='.33\\textwidth', fig.cap='Tests of pairwise independence for every third Fourier frequency starting at the first, second and third Fourier frequencies, respectively.', fig.pos='H'>>=
g_space2a.ar4
g_space2b.ar4
g_space2c.ar4
@
